<div class="text-gray-100 p-8">
            ...
            <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10">
                ...
                <x-card class="w-full max-w-xs bg-gradient-to-b from-green-900 to-green-800 border border-green-700 shadow-xl rounded-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 ease-in-out">
                    ...
                    <div class="mt-4 p-4  rounded-md">
                        <x-button
                            label="View Comments"
                            wire:click="showComments({{ $cot->id }})"
                            class="bg-gray-800 hover:bg-green-700 text-white px-5 py-2 rounded-md"
                        />
                    </div>
                </x-card>
                @endforeach
    ...
    <x-modal wire:model.defer="showCommentsModal">
        <x-card title="Comments for {{ $selectedProduct ? $selectedProduct->productname : 'Unknown Product' }}">
            <div class="space-y-4">
