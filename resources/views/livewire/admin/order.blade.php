<div>
        ...
        <div class="flex gap-2 mt-2 p-4" >
            <x-input label="" placeholder="Search..." wire:model="search"  wire:keyup="autoSearch"/>
        <div>
            ...
            <table class=" text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 w-screen " >
                ...
                <tbody style="width: 2000px;">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 ">
                          <span>
                            <button class="text-green-700 hover:bg-text-800" wire:click="confirmOrder({{ $cot->id }})">Confirm</button>
